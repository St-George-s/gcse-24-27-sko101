...
while wantToContinue == "Y":
    ...
    while numberOfGuessesLeft != 0 and unguessedWord != word:
        ...
        if unguessedWord != word:
            letterHasBeenGuessedAlready = 0
            doubleLetterVariable = 0
            found = False
            ...
            for counter3 in range(len(word)):
                ...
                if guess == word[counter3]:
                    ...
                    found = True
                    doubleLetterVariable = doubleLetterVariable + 1
            print(unguessedWord)
...
# double letter issue
            ...
            for counter6 in range(len(everyGuessedLetter)):
                if guess == everyGuessedLetter[counter6]:
                    letterHasBeenGuessedAlready = letterHasBeenGuessedAlready + 1
            if letterHasBeenGuessedAlready > doubleLetterVariable and doubleLetterVariable < letterHasBeenGuessedAlready + 2:
            ...
            if loseLetterAfterGuessingAgain == "N":
                for counter5 in range(len(everyGuessedLetter)):
                    if guess == everyGuessedLetter[counter5]:
